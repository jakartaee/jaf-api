...
public class FileDataSource implements DataSource {
	...
	public FileDataSource(File file) {
		_path = file.toPath(); // save the file as Path object...
	}
	...
	/**
	 * Creates a FileDataSource from the specified path name. <i>Note: The file will
	 * not actually be opened until a method is called that requires the file to be
	 * opened.</i>
	 *
	 ...
	 * <code>getDefaultFileTypeMap</code> method on FileTypeMap to acquire a default
	 * FileTypeMap. <i>Note: By default, the FileTypeMap used will be a
